...
- Prefer the core ADR template from `governance-kernel` (`~/ai-society/holdingco/governance-kernel/docs/core/system4d/TEMPLATE-ADR.md`).
- Prefer the core RFC template from `governance-kernel` (`~/ai-society/holdingco/governance-kernel/docs/core/system4d/TEMPLATE-RFC.md`).
