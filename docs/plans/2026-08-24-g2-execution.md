---
summary: "G2 additional candidate-wheel cell execution against 7a41ea3. Still not Gate G2 PASS."
read_when:
...
Candidate wheel from `7a41ea3`, empty cwd, no checkout fallback.
