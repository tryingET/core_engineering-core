---
name: ec-lane-pi-ts.justfile
description: [ec-lane] pi extension TypeScript lane standardized Justfile addendum. Load when: A repo using the pi extension TypeScript lane is missing, establishing, or reconciling the standardized Justfile surface.; Standard targets are absent, drifting, or need lane-specific command mapping.
---
